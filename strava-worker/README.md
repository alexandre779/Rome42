...
Il utilise `STRAVA_WEBHOOK_VERIFY_TOKEN` pour la vérification de souscription. Les événements d’activité ne sont pas stockés ; le webhook sert notamment à traiter la révocation d’accès.
